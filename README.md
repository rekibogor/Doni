...
<body>
    <div class="container">
        <h1>Biodata Diri</h1>
        <div class="biodata">
            <p><strong>Nama:</strong> Doni </p>
            <p><strong>Tempat, Tanggal Lahir:</strong> Gantiwarno, 14-juni-2004 </p>
            <p><strong>Alamat:</strong> Gantiwarno </p>
